...
let initialize = () => {
	mysqlConfig.getDB().query("create table IF NOT EXISTS shopSizes (id INT auto_increment primary key, description VARCHAR(30), capacity INT, slotDuration TIME, bufferDuration TIME)");
