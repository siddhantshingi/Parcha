...
class UserHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Token> tokens = [
      Token(tokenId: 0, date: '11 May', startTime: '11:00', status: 0),
      Token(tokenId: 1, date: '11 May', startTime: '13:00', status: 1),
      Token(tokenId: 2, date: '11 May', startTime: '14:00', status: 2),
      Token(tokenId: 2, date: '11 May', startTime: '15:00', status: 1),
      Token(tokenId: 2, date: '11 May', startTime: '15:30', status: 4),
      Token(tokenId: 2, date: '11 May', startTime: '10:30', status: 3),
    ];
